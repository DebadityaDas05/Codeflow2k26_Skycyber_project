                                                ...
                                                <div className="pt-5 border-t border-slate-850/60 flex flex-wrap justify-between items-center gap-5">
                                                    ...
                                                    <div className="flex gap-2.5">
                                                        ...
                                                        {trackingMap[activeJob.id].stage === "Completed" && (
                                                            <span className="text-[10px] font-bold text-orange-400 flex items-center gap-2 animate-pulse bg-orange-500/5 px-4.5 py-2.5 rounded-xl border border-orange-500/10">
                                                                <span className="w-1.5 h-1.5 rounded-full bg-orange-500"></span>
                                                                <span>Awaiting Escrow Sign-off</span>
                                                            </span>
                                                        )}
